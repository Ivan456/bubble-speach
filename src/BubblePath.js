export default class BubblePath {
  ...
  generatePath() {
    ...
    if (this.pointer.x < x && this.pointer.y >= y && this.pointer.y <= b) {
  ...
  create() {
    ...
    this.bubble.set({
      id: this.additioanalProps.id || this.id,
      additioanalProps: this.additioanalProps,
  ...
  scaling() {
    ...
    if (this.direction == 0) {
      ...
      let kw =
        (this.fabricPathText[3][1] - this.fabricPathText[9][1]) /
        (this.fabricPathText[3][1] - this.fabricPathText[8][1])
    ...
    if (this.direction == 2) {
      let kh =
        ...
        (this.fabricPathText[9][2] - this.fabricPathText[2][2])
      this.y =
        this.bubble.oCoords.tl.y +
        (1 - kh) * (this.bubble.oCoords.bl.y - this.bubble.oCoords.tl.y)
      if (
        ...
        let kw =
          (this.fabricPathText[5][1] - this.fabricPathText[11][1]) /
          (this.fabricPathText[5][1] - this.fabricPathText[2][1])
    ...
    if (this.direction == 1) {
      ...
      k =
        (-this.bubble.oCoords.tl.y + this.bubble.oCoords.bl.y) /
        (this.fabricPathText[7][2] - this.fabricPathText[2][2])
      this.pointer.y =
    ...
    if (this.direction == 3) {
      ...
      if (
        ...
        this.fabricPathText[6][1] < this.fabricPathText[4][1]
      ) {
        k =
          (-this.bubble.oCoords.bl.x + this.bubble.oCoords.br.x) /
          (this.fabricPathText[9][1] - this.fabricPathText[4][1])
        this.pointer.x =
        ...
        // left
        let kw =
          (this.fabricPathText[4][1] - this.fabricPathText[9][1]) /
        ...
        this.x =
          ...
          (this.bubble.oCoords.br.x - this.bubble.oCoords.bl.x) * (1 - kw)
        this.y = this.bubble.oCoords.tl.y
